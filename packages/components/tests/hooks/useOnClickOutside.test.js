...
describe("useOnClickInside", () => {
    test("Should run handler on click outside element.", () => {
        ...
        const { result } = (0, react_1.renderHook)(() => {
            ...
            (0, hooks_1.useOnClickOutside)(ref, handler);
            return ref;
        });
    ...
    test("Should not run handler on click multiple elements.", () => {
        ...
        const { result } = (0, react_1.renderHook)(() => {
            ...
            (0, hooks_1.useOnClickOutside)([ref1, ref2, ref3], handler);
        ...
        react_1.fireEvent.mouseDown(react_1.screen.getAllByRole("button")[3]);
        expect(handler).toHaveBeenCalledTimes(1);
    });
});
