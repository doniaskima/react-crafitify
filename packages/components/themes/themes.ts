...
export type CraftifyUserTheme = DeepPartial<CraftifyUIThemes> & { type: string }
...
const create = (base: CraftifyUIThemes, custom: CraftifyUserTheme): CraftifyUIThemes => {
...
const createFromLight = (custom: CraftifyUserTheme) => create(lightTheme, custom)
