...
const CuteFace_1 = __importDefault(require("../CuteFace/CuteFace"));
exports.default = {
    title: 'Spinners/CuteFace',
    component: CuteFace_1.default,
};
const Template = (args) => react_1.default.createElement(CuteFace_1.default, Object.assign({}, args));
