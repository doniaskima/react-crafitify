...
const Mouse_1 = __importDefault(require("../Mouse/Mouse"));
exports.default = {
    title: 'Spinners/Mouse',
    component: Mouse_1.default,
};
const Template = (args) => react_1.default.createElement(Mouse_1.default, Object.assign({}, args));
