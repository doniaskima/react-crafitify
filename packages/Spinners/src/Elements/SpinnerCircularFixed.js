...
exports.SpinnerCircularFixed = void 0;
...
const StyledAnimatedCircle = (0, styled_components_1.default)(StyledCircle) `
  ...
  animation: ${spinAnimation} ${props => 140 / props.speed}s linear infinite;
`;
const Component = (_a) => {
...
exports.SpinnerCircularFixed = (0, withSharedProps_1.withSharedProps)(Component);
